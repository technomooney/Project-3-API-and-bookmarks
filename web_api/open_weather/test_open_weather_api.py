...
class TestAPIRequest(unittest.TestCase):
    ...
    def test_return_list_from_requests(self,mock_get):
        ...
        response = open_weather_map.get_api_response(lon = -110.5471695,lat = 44.59824417)
